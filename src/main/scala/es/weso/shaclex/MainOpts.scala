...
class MainOpts(arguments: List[String], onError: (Throwable, Scallop) => Nothing) extends ScallopConf(arguments) {
  ...
  val schema: ScallopOption[String] = opt[String]("schema", short = 's', default = None, descr = "schema file")
  ...
  val schemaUrl: ScallopOption[String] = opt[String]("schemaUrl", noshort = true, default = None, descr = "schema Url")

  val data: ScallopOption[String] = opt[String]("data", default = None, descr = "Data file(s) to validate", short = 'd')
  ...
  val endpoint: ScallopOption[String] = opt[String]("endpoint", default = None, descr = "Endpoint", short = 'e')

  val shapeMap: ScallopOption[String] = opt[String]("shapeMap", default = None, descr = s"Shape map", noshort = true)
  ...
  val showVersion: ScallopOption[Boolean] = toggle(
    name = "version",
    prefix = "no-",
    default = Some(false),
  ...
  val validationReportFile: ScallopOption[String] = opt[String](
    name = "validationReportFile",
    default = None,
    descr = s"File to store validation report",
    noshort = true
  )
  ...
  val clingoFile: ScallopOption[String] =
    opt[String]("clingoFile", default = None, descr = "save validation to Clingo file", noshort = true)

  val outputFile: ScallopOption[String] =
    opt[String]("outFile", default = None, descr = "save report to file", short = 'f')

  val outSchemaFormat: ScallopOption[String] =
    opt[String]("outSchemaFormat", default = Some(defaultSchemaFormat), descr = "schema format to show", noshort = true)

  val outSchemaFile: ScallopOption[String] =
    opt[String]("outSchemaFile", default = None, descr = "filename to save output schema", noshort = true)
  ...
  val outDataFormat: ScallopOption[String] =
    opt[String]("outDataFormat", default = None, descr = "data format to show", noshort = true)

  val baseFolder: ScallopOption[String] = opt[String]("baseFolder", default = None, descr = "base folder", short = 'b')

  val node: ScallopOption[String] =
    opt[String]("node", short = 'n', default = None, required = false, descr = "Node to validate")
  ...
  val shapeInfer: ScallopOption[Boolean] = toggle(
    "shapeInfer",
    prefix = "no-",
    default = Some(false),
  ...
  val shapeInferNode: ScallopOption[String] =
    opt[String]("shapeInferNode", default = None, required = false, descr = "Node selector for shapeInfer option")

  val shapeInferLabel: ScallopOption[String] = opt[String](
    "shapeInferLabel",
    default = Some("Shape"),
    required = false,
  ...
  val shapeInferEngine: ScallopOption[String] =
    opt[String]("shapeInferEngine", default = Some("ShEx"), required = false, descr = "Engine for shapeInfer option")

  val shapeInferFormat: ScallopOption[String] =
    opt[String]("shapeInferFormat", default = Some("ShExC"), required = false, descr = "Format for shapeInfer option")

  val testShEx: ScallopOption[String] = opt[String](
    "testShEx",
    default = None,
    required = false,
